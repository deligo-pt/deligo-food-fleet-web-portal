...
import { submitForApprovalReq, uploadImagesReq } from "@/services/becomeAgent/becomeAgentManagement";
...
export default function AgreementViewer({ agreement, fleetId, type = 'new' }: AgreementViewerProps) {
    ...
    const handleContinue = async () => {
        ...
        const result = await submitForApprovalReq(fleetId as string);
            ...
            <div className="space-y-4">
                <div className="relative p-0">
                    <Button
                        onClick={() => router.back()}
                        variant="link"
                        className="inline-flex items-center px-4 text-sm gap-2 text-[#DC3173] p-0 h-4 z-10 cursor-pointer"
                    >
