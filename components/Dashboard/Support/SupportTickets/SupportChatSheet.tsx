      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6 bg-gray-50/50">
          {messagesData.data?.map((msg) => {
            const isManager = msg.senderRole === "FLEET_MANAGER";
            return (
              <div
                key={msg._id}
              ...
              >
                ...
                <div
                  className={`max-w-[85%] px-4 py-2.5 rounded-2xl text-sm ${isManager ? "bg-[#DC3173] text-white rounded-tr-sm" : "bg-white border border-gray-100 text-gray-800 rounded-tl-sm shadow-sm"}`}
                >
                  {msg.message}
                  <div className="flex justify-between items-center mt-1 gap-2">
                    <span
                      className={cn(
                        ...
                        isManager ? "text-gray-300" : "text-gray-400",
                      )}
                    >
