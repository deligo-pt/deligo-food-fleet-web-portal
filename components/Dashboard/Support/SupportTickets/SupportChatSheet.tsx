...
import SupportChatInput from "@/components/Dashboard/Support/SupportTickets/SupportChatInput";
import SupportMessageItem from "@/components/Dashboard/Support/SupportTickets/SupportMessageItem";
...
export default function SupportChatSheet({ ticket, closeChatSheet }: IProps) {
  ...
  const handleSendMessage = async (text: string) => {
    ...
    const optimisticMsg: TSupportMessage = {
      ...
      senderRole: USER_ROLE.FLEET_MANAGER,
      message: text.trim(),
      messageType: "TEXT",
      attachments: [],
      readBy: {},
