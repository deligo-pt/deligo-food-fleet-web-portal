...
const DeliveryPartnerPerformance = ({
  ...
  partnerPerformance: IPartnersAnalyticsResponse;
}) => {
    ...
    <div>
      ...
      <div className="flex flex-row justify-between items-center my-5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          ...
          <button
            onClick={() => exportCSV(partnerPerformance.table.data)}
            className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-white border shadow-sm text-sm hover:scale-105 transition"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <PartnerPerformanceCard
          ...
          value={
            partnerPerformance?.cards?.topPartnerDeliveries?.toString() || "0"
          }
      ...
      <style jsx>{`
        ...
        .animate-slide-in {
          animation: slide-in 200ms cubic-bezier(0.2, 0.9, 0.2, 1) both;
        }
      `}</style>
    </div>
  );
