...
import { Badge, issueStyles, statusStyles } from '../DeliveryPartnerEmergencyAlerts/SosBadges';
import SosDetailsModal from '../DeliveryPartnerEmergencyAlerts/SosDetailsModal';
...
const ReportInsights = ({ sosAlerts }: IProps) => {
    ...
    return (
        <>
            ...
            >
                <DashboardPageHeader
                    title={t("report_insights")}
                    desc={t("get_clear_overview_data")}
                />
            </motion.div>
