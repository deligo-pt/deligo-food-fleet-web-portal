...
export default function Sidebar() {
  ...
  const MENU = [
    ...
    },
    {
      ...
      items: [
        { name: "New Orders", path: "/agent/new-orders" },
        { name: "Preparing", path: "/agent/preparing" },
        { name: "Ready for Pickup", path: "/agent/ready-for-pickup" },
        { name: "Ongoing Deliveries", path: "/agent/ongoing-deliveries" },
        { name: "Completed", path: "/agent/completed" },
        { name: "Cancelled", path: "/agent/cancelled" },
      ],
    },
    {
      id: "menu",
      ...
      icon: <Layers size={18} />,
      items: [
        { name: "All Items", path: "/agent/all-items" },
        { name: "Categories", path: "/agent/categories" },
        { name: "Add New Item", path: "/agent/add-item" },
        { name: "Stock Management", path: "/agent/stock" },
        { name: "Add-ons", path: "/agent/addons" },
      ],
    },
    {
      id: "payments",
      ...
      items: [
        { name: "Payouts", path: "/agent/payouts" },
        { name: "Earnings Summary", path: "/agent/earnings" },
        { name: "Payment Settings", path: "/agent/payment-settings" },
        { name: "Transaction History", path: "/agent/transactions" },
      ],
    },
    {
      id: "analytics",
      ...
      items: [
        { name: "Sales Analytics", path: "/agent/sales-analytics" },
        { name: "Customer Insights", path: "/agent/customer-insights" },
        { name: "Order Trends", path: "/agent/order-trends" },
        { name: "Top Performing Items", path: "/agent/top-items" },
      ],
    },
    {
      id: "reviews",
      ...
      icon: <Star size={18} />,
      items: [
        { name: "Customer Reviews", path: "/agent/reviews" },
        { name: "Rating Summary", path: "/agent/rating-summary" },
      ],
    },
    {
      id: "inventory",
      ...
      icon: <Box size={18} />,
      items: [
        { name: "Ingredients", path: "/agent/ingredients" },
        { name: "Stock Alerts", path: "/agent/stock-alerts" },
        { name: "Suppliers", path: "/agent/suppliers" },
      ],
    },
    {
      id: "offers",
      ...
      icon: <Gift size={18} />,
      items: [
        { name: "Active Offers", path: "/agent/offers" },
        { name: "Create New Offer", path: "/agent/create-offer" },
        { name: "Coupon Analytics", path: "/agent/coupon-analytics" },
      ],
    },
    {
      id: "staff",
      ...
      icon: <Users size={18} />,
      items: [
        { name: "All Staff", path: "/agent/all-staff" },
        { name: "Roles & Permissions", path: "/agent/roles" },
        { name: "Add New Staff", path: "/agent/add-staff" },
      ],
    },
    {
      id: "integrations",
      ...
      icon: <Plug size={18} />,
      items: [
        { name: "POS Integration", path: "/agent/pos" },
        { name: "Delivery Partner", path: "/agent/delivery-partner" },
        { name: "Marketing Tools", path: "/agent/marketing" },
        { name: "API Access", path: "/agent/api-access" },
      ],
    },
    {
      id: "reports",
      ...
      items: [
        { name: "Sales Report", path: "/agent/sales-report" },
        { name: "Tax Report", path: "/agent/tax-report" },
        { name: "Custom Report", path: "/agent/custom-report" },
      ],
    },
    {
      id: "settings",
      ...
      items: [
        { name: "Business Info", path: "/agent/business-info" },
        { name: "Notifications", path: "/agent/notifications" },
        { name: "Payment Settings", path: "/agent/payment-settings" },
        { name: "Theme & Branding", path: "/agent/theme" },
      ],
    },
    {
      id: "support",
      ...
      items: [
        ...
        { name: "Help Articles", path: "/agent/help" },
        { name: "Report an Issue", path: "/agent/report" },
      ],
    },
    {
      id: "sos",
      ...
      items: [
        { name: "Contact Support", path: "/agent/contact-support" },
        { name: "Safety Guidelines", path: "/agent/safety" },
      ],
    },
  ];
