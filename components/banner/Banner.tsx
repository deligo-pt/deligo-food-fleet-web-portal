...
export default function AgentHeroBackground() {
          ...
          <div className="md:col-span-7 lg:col-span-6">
            <div className="max-w-xl">
              <p className="inline-flex items-center gap-2 text-sm font-medium uppercase text-[#DC3173] tracking-wider mb-4">
                <span className="rounded-full bg-[#DC3173]/10 px-3 py-1 text-[#DC3173]">Partner</span>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight text-black">
                Join Our <span className="text-[#DC3173]">Delivery Network</span> in Portugal
              </h1>

              <p className="mt-6 text-lg text-gray-700">
                Become a verified delivery boy agent and start working today. Access a reliable platform,
                steady earnings, and tools to manage your deliveries efficiently.
              </p>
  ...
  ✓
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Verified partners</div>
  ...
  <div className="relative w-full h-64 rounded-2xl overflow-hidden bg-gradient-to-tr from-[#FFC0D9] via-[#FFE6F0] to-[#FFD1E8] flex items-center justify-center">
    <svg viewBox="0 0 240 140" fill="none" className="w-72 h-48">
      {/* Base rectangle */}
      <rect x="0" y="30" width="240" height="80" rx="18" fill="#fff" />

      <g transform="translate(12,36)" className="animate-float">
  <rect x="0" y="4" width="120" height="45" rx="8" fill="#fbb4c7" />   {/* left card */}
  <rect x="125" y="4" width="120" height="45" rx="8" fill="#e6e6e6" />  {/* right card, slightly gray for contrast */}
  <circle cx="32" cy="65" r="14" fill="#e6e6e6" />                       {/* left wheel */}
  <circle cx="218" cy="65" r="14" fill="#fbb4c7" />                      {/* right wheel */}
</g>

      {/* Decorative arcs */}
      <path d="M28 30 C40 10, 80 10, 100 30" stroke="#DC3173" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="animate-pulseStroke" />
      <path d="M130 30 C150 10, 190 10, 212 30" stroke="#ff8fb6" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="animate-pulseStroke delay-2000" />
    </svg>
  </div>
